namespace Liduv.UndoRedo
{
  ...
  using Liduv.UndoRedo.ChangeTypes;
  ...
  public class UndoRoot
  {
    ...
    private Stack<Liduv.UndoRedo.ChangeSet> _UndoStack;
    private Stack<Liduv.UndoRedo.ChangeSet> _RedoStack;
    ...
    private Liduv.UndoRedo.ChangeSet _CurrentBatchChangeSet;
    ...
    public UndoRoot(object root)
    {
      ...
      this._UndoStack = new Stack<Liduv.UndoRedo.ChangeSet>();
      this._RedoStack = new Stack<Liduv.UndoRedo.ChangeSet>();
    }
    ...
    /// </summary>
    public IEnumerable<Liduv.UndoRedo.ChangeSet> UndoStack
    {
    ...
    /// </summary>
    public IEnumerable<Liduv.UndoRedo.ChangeSet> RedoStack
    {
    ...
    public void BeginChangeSetBatch(string batchDescription, bool consolidateChangesForSameInstance)
    {
      ...
      if (this._IsInBatchCounter == 1)
      {
        ...
        this._CurrentBatchChangeSet = new Liduv.UndoRedo.ChangeSet(this, batchDescription, null);
